...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/admin/userList">Danh sách đơn hàng</a></li>
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <!-- <div class="text-end upgrade-btn">
                            <a href="/admin/createUserInAdmin"
                                class="btn btn-danger d-none d-md-inline-block text-white">Add User</a>
                        </div> -->
                    </div>
                </div>
            </div>
                               ...
                               <!--  <h4 class="card-title">Danh sách người dùng</h4> -->
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table user-table">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Người đặt</th>
                                        ...
                                        <c:forEach items="${orderListInAdmin}" var="order">
                                            <tr>
                                                ...
                                                <td>${order.orderdetails[0].dayOrder}</td>
													<td>
													<p hidden>${order.id}</p>
													<select size="1" class="row-2-office" name="row-2-office">
														<c:forEach items="${status}" var="s">
															<c:choose>
																<c:when test="${order.statusOrder == order.status(s)}">
																	<option value="${order.status(s)}" selected="selected">${s}</option>
																</c:when>
															<c:otherwise>
																<option value="${order.status(s)}">${s}</option>
															</c:otherwise>

														</c:choose>
															<%-- <option value="${order.statusOrder}">${s}</option> --%>
    ...
    $(document).ready( function () {
    	$('.row-2-office').change(function(){
    		var status = $(this).val();
    		var orderid = $(this).parent().find("p").text();
