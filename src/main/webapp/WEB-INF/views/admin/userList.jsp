...
<body>
                                    ...
                                    <table id="myTable" class="table user-table">
                                        ...
                                        <c:forEach items="${userList}" var="users">
                                            <tr>
                                                <td>
                                                   	<div class="delete">
                                                        <button uid="${users.id}" class="btn btn-success mx-auto mx-md-0 text-white delete">Xóa</button>
                                                     </div>
                                                </td>
                                                    
                                                    
                                                <td><a href="/admin/userInformation/${users.id}">${users.userName}</a></td>
                                                <td>${users.email}</td>
													<td>
													<p hidden>${users.id}</p>
													<select size="1" class="row-2-office" name="row-2-office">
														<c:forEach items="${permission}" var="p">
															<c:choose>
																<c:when test="${p == users.userPermission}">
	...
	$('.row-2-office').change(function(){
		...
		var userid = $(this).parent().find("p").text();
